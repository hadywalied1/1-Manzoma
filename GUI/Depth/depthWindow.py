...
class DepthWindow(QWidget):
    ...
    def __init__(self, id):
        ...
        instructions = """
                    تعليمات الإختبار\n
                \n
                    1- اجلس علي المقعد المخصص للإختبار و امسك طرفي الخيط \n
                    2- انظر داخل الجهاز  و حاول وضع الخشبتين في وضع متوازي \n
                    3- عندما تنتهي قم بالإشارة الي الممتحن لتسجيل النتيجة \n
                \n
        """
